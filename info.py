...
BOT_TOKEN = environ.get("BOT_TOKEN", "8372415119:AAHu0xXAvdvbe8vRxdvignqMGHWn5vxfmFk")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002524408666').split()]
...
DATABASE_URI3 = environ.get('DATABASE_URI3', "mongodb+srv://melodysotto4_db_user:BCUKIKDEAqFEzeCj@cluster0.trrt89o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
